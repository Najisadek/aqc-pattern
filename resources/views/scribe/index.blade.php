    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-orders--order_id--cancel">POST api/orders/{order_id}/cancel</a>
                            </li>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>discontinued</code></li> <li><code>draft</code></li></ul>
        </div>
        </form>
...
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-orders--order_id--cancel">POST api/orders/{order_id}/cancel</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/orders/16/cancel" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/orders/16/status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"status\": \"cancelled\"
...
Must be one of:
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>processing</code></li> <li><code>shipped</code></li> <li><code>delivered</code></li> <li><code>cancelled</code></li> <li><code>refunded</code></li></ul>
        </div>
        </form>
